...
import { EventDetails } from '../components/dashboard/organizer-dashboard/EventDetails';
import { AllEvents } from '../components/dashboard/organizer-dashboard/AllEvents';
    ...
    <BrowserRouter>
      <Box display='flex' flexDirection='column' sx={{ minHeight: '100vh' }}>
        ...
        <Routes>
          ...
          <Route path={AppRoutes.ALL_EVENTS} element={<AllEvents />} />
